...
public class MsgUtil {
    ...
    public static SendSmsResponse sendSms(String code, String phoneNum) throws ClientException {
        //可自助调整超时时间
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("驯鹿妖妖");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_136300026");
    ...
    public static void sendSmsAndGetResponse(String code, String phoneNum) throws ClientException, InterruptedException{
        //发短信
        SendSmsResponse response = sendSms(code, phoneNum);
